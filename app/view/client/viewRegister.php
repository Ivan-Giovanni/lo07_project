...
<div class="container">
    ...
    echo("<h2 style='color: red; text-align: center'>Inscrivez-vous</h2>");
    echo("</div>");
    ?>
        ...
        <div class='mx-lg-3'>
            ...
            <form role="form" method='get' action='router2.php'>
                <div class="form-group">
                    <input type="hidden" name='action' value='clientRegistered'>

                    <label for="login" class="form-label"><b>Nom</b></label>
                    <input type="text" class="form-control" id="nom" name="nom" required><br/>

                    <label for="password" class="form-label"><b>Prenom</b></label>
                    <input type="text" class="form-control" id="prenom" name="prenom" required><br/>

                    <label for="password" class="form-label"><b>Login</b></label>
