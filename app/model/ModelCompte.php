...
class ModelCompte
{
    ...
    public static function getAllCompte($banque_id)
    {
        try {
            ...
            $query = "SELECT personne.prenom, personne.nom, banque.label AS 'banque', compte.label AS 'compte', compte.montant FROM personne JOIN compte ON personne.id = compte.personne_id JOIN banque ON compte.banque_id = banque.id WHERE compte.banque_id = :banque_id;";
